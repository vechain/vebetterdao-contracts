 ...
 */
library PassportWhitelistAndBlacklistLogicV3 {
  // ---------- Events ---------- //
  ...
  function isWhitelisted(PassportStorageTypesV3.PassportStorage storage self, address user) internal view returns (bool) {
    return self.whitelisted[user];
  }

  /// @notice Returns if a user is blacklisted
  function isBlacklisted(PassportStorageTypesV3.PassportStorage storage self, address user) internal view returns (bool) {
    return self.blacklisted[user];
  }

  /// @notice return the blacklist threshold
  function blacklistThreshold(PassportStorageTypesV3.PassportStorage storage self) internal view returns (uint256) {
    return self.blacklistThreshold;
  }

  /// @notice return the whitelist threshold
  function whitelistThreshold(PassportStorageTypesV3.PassportStorage storage self) internal view returns (uint256) {
  ...
  function whitelist(PassportStorageTypesV3.PassportStorage storage self, address user) external {
  ...
  function removeFromWhitelist(PassportStorageTypesV3.PassportStorage storage self, address user) public {
  ...
  function blacklist(PassportStorageTypesV3.PassportStorage storage self, address user) external {
  ...
  function removeFromBlacklist(PassportStorageTypesV3.PassportStorage storage self, address user) public {
  ...
  function setWhitelistThreshold(PassportStorageTypesV3.PassportStorage storage self, uint256 threshold) external {
  ...
  function setBlacklistThreshold(PassportStorageTypesV3.PassportStorage storage self, uint256 threshold) external {
  ...
  function _updatePassportBlacklistCounter(
    ...
    address passport = PassportEntityLogicV3._getPassportForEntity(self, user);
  ...
  function _isPassportWhitelisted(
    ...
    passport = PassportEntityLogicV3._getPassportForEntity(self, passport);
    ...
    uint256 totalEntities = PassportEntityLogicV3.getEntitiesLinkedToPassport(self, passport).length;
