...
/**
 * @title RoundFinalizationUpgradeableV4
 * @notice Extension of {XAllocationVotingGovernorV4} that handles the finalization of rounds
 ...
 */
abstract contract RoundFinalizationUpgradeableV4 is Initializable, XAllocationVotingGovernorV4 {
  /// @custom:storage-location erc7201:b3tr.storage.XAllocationVotingGovernorV4.RoundFinalization
  ...
  // keccak256(abi.encode(uint256(keccak256("b3tr.storage.XAllocationVotingGovernorV4.RoundFinalization")) - 1)) & ~bytes32(uint256(0xff))
  ...
  function finalizeRound(uint256 roundId) public virtual override {
    require(!isActive(roundId), "XAllocationVotingGovernorV4: round is not ended yet");
