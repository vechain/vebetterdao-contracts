...
/**
 * @title VotesUpgradeableV4
 * @dev Extension of {XAllocationVotingGovernorV4} for voting weight extraction from an {ERC20Votes} token, or since v4.5 an {ERC721Votes}
 * token.
 */
abstract contract VotesUpgradeableV4 is Initializable, XAllocationVotingGovernorV4 {
  /// @custom:storage-location erc7201:b3tr.storage.XAllocationVotingGovernorV4.VotesUpgradeableV4
  struct VotesStorage {
    IERC5805 _token;
  }

  // keccak256(abi.encode(uint256(keccak256("b3tr.storage.XAllocationVotingGovernorV4.VotesUpgradeableV4")) - 1)) & ~bytes32(uint256(0xff))
