...
/**
 * @title VotingSettingsUpgradeableV4
 * @dev Extension of {XAllocationVotingGovernorV4} for voting settings.
 */
abstract contract VotingSettingsUpgradeableV4 is Initializable, XAllocationVotingGovernorV4 {
  /// @custom:storage-location erc7201:b3tr.storage.XAllocationVotingGovernorV4.VotingSettings
  struct VotingSettingsStorage {
    uint32 _votingPeriod;
  }

  // keccak256(abi.encode(uint256(keccak256("b3tr.storage.XAllocationVotingGovernorV4.VotingSettings")) - 1)) & ~bytes32(uint256(0xff))
