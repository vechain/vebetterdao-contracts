...
import "../V2/interfaces/IEmissionsV2.sol";
 ...
 */
contract VoterRewardsV4 is AccessControlUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
  ...
  function initialize(
    ...
    $.b3tr = IB3TR(_b3tr);
    $.emissions = IEmissionsV2(_emissions);
  ...
  function emissions() external view returns (IEmissionsV2) {
    VoterRewardsStorage storage $ = _getVoterRewardsStorage();
    return $.emissions;
  }
