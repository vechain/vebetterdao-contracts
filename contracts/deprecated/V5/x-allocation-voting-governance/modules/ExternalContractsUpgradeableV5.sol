...
import { XAllocationVotingGovernorV5 } from "../XAllocationVotingGovernorV5.sol";
 ...
 */
abstract contract ExternalContractsUpgradeableV5 is Initializable, XAllocationVotingGovernorV5 {
  ...
  function __ExternalContracts_init(
    ...
    IEmissionsV2 initialEmissions,
    IVoterRewardsV4 initialVoterRewards
   ...
   */
  function emissions() public view override returns (IEmissionsV2) {
    ExternalContractsStorage storage $ = _getExternalContractsStorage();
    return $._emissions;
  }
   ...
   */
  function voterRewards() public view override returns (IVoterRewardsV4) {
    ExternalContractsStorage storage $ = _getExternalContractsStorage();
   ...
   */
  function _setEmissions(IEmissionsV2 newEmisionsAddress) internal virtual {
    ...
    $._emissions = IEmissionsV2(newEmisionsAddress);
  }
   ...
   */
  function _setVoterRewards(IVoterRewardsV4 newVoterRewards) internal virtual {
