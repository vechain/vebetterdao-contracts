...
import "./x-allocation-voting-governance/XAllocationVotingGovernorV5.sol";
import "./x-allocation-voting-governance/modules/RoundVotesCountingUpgradeableV5.sol";
import "./x-allocation-voting-governance/modules/VotesUpgradeableV5.sol";
import "./x-allocation-voting-governance/modules/VotesQuorumFractionUpgradeableV5.sol";
import "./x-allocation-voting-governance/modules/VotingSettingsUpgradeableV5.sol";
import "./x-allocation-voting-governance/modules/RoundEarningsSettingsUpgradeableV5.sol";
import "./x-allocation-voting-governance/modules/RoundFinalizationUpgradeableV5.sol";
import "./x-allocation-voting-governance/modules/RoundsStorageUpgradeableV5.sol";
import "./x-allocation-voting-governance/modules/ExternalContractsUpgradeableV5.sol";
 ...
 */
contract XAllocationVotingV5 is
  XAllocationVotingGovernorV5,
  VotingSettingsUpgradeableV5,
  RoundVotesCountingUpgradeableV5,
  VotesUpgradeableV5,
  VotesQuorumFractionUpgradeableV5,
  RoundEarningsSettingsUpgradeableV5,
  ExternalContractsUpgradeableV5,
  RoundsStorageUpgradeableV5,
  RoundFinalizationUpgradeableV5,
  ...
  UUPSUpgradeable
{
  ...
  struct InitializationData {
    ...
    address timeLock;
    IVoterRewardsV4 voterRewards;
    IEmissionsV2 emissions;
    address[] admins;
    address upgrader;
   ...
   */
  function setEmissionsAddress(IEmissionsV2 newEmissions) external onlyRole(CONTRACTS_ADDRESS_MANAGER_ROLE) {
   ...
   */
  function setVoterRewardsAddress(IVoterRewardsV4 newVoterRewards) external onlyRole(CONTRACTS_ADDRESS_MANAGER_ROLE) {
  ...
  function votingPeriod()
    public
    view
    override(XAllocationVotingGovernorV5, VotingSettingsUpgradeableV5)
    returns (uint256)
  {
  ...
  function quorum(
    uint256 blockNumber
  ) public view override(XAllocationVotingGovernorV5, VotesQuorumFractionUpgradeableV5) returns (uint256) {
    return super.quorum(blockNumber);
  }

  function supportsInterface(
    bytes4 interfaceId
  ) public view override(AccessControlUpgradeable, XAllocationVotingGovernorV5) returns (bool) {
