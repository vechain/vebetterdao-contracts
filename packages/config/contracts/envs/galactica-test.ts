...
export function createGalacticaTestConfig() {
  return defineConfig({
    NEXT_PUBLIC_APP_ENV: "galactica-test",
    ...
    */
    ...
    EMISSIONS_CYCLE_DURATION: 48, // 48 blocks - 8 minutes.
    ...
    CONTRACTS_ADMIN_ADDRESS: "0x10B5C7e9Fde7865714c60761cb9388d342346153", //1st account from mnemonic of galactica test network
    VOTE_2_EARN_POOL_ADDRESS: "0x74DB0078F2FB058227fc377C190CefFbeB368Cf1", //2nd account from mnemonic of galactica test network
    ...
    */
    ...
    // Migration
    MIGRATION_ADDRESS: "0xBe5Aaf2304B27b2b437645D8E0F0Ec8Ab49e0dfA", // 10th account from mnemonic of galactica test network
    MIGRATION_AMOUNT: BigInt("3750000000000000000000000"), // 3.75 million B3TR tokens from pilot show

    // Version 2
    VECHAIN_NODES_CONTRACT_ADDRESS: "0xb81E9C5f9644Dec9e5e3Cac86b4461A222072302", // The contract address of the VeChainNodes contract on galactica test network
