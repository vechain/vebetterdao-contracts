...
import { IDynamicBaseAllocationPoolV2 as IDynamicBaseAllocationPool } from "./interfaces/IDynamicBaseAllocationPoolV2.sol";
  ...
  IDynamicBaseAllocationPool
{
  ...
  struct DBAPoolStorage {
    ...
    mapping(uint256 roundId => bool) dbaRewardsDistributed;
    mapping(uint256 roundId => mapping(bytes32 appId => uint256 amount)) dbaRoundRewardsForApp;
  }
