...
import { PassportTypesV4 } from "./libraries/PassportTypesV4.sol";
import { PassportStorageTypesV4 } from "./libraries/PassportStorageTypesV4.sol";
import { PassportChecksLogicV4 } from "./libraries/PassportChecksLogicV4.sol";
import { PassportWhitelistAndBlacklistLogicV4 } from "./libraries/PassportWhitelistAndBlacklistLogicV4.sol";
import { PassportPoPScoreLogicV4 } from "./libraries/PassportPoPScoreLogicV4.sol";
import { PassportEntityLogicV4 } from "./libraries/PassportEntityLogicV4.sol";
import { PassportClockLogicV4 } from "./libraries/PassportClockLogicV4.sol";
import { PassportDelegationLogicV4 } from "./libraries/PassportDelegationLogicV4.sol";
import { PassportSignalingLogicV4 } from "./libraries/PassportSignalingLogicV4.sol";
import { PassportPersonhoodLogicV4 } from "./libraries/PassportPersonhoodLogicV4.sol";
import { PassportEIP712SigningLogicV4 } from "./libraries/PassportEIP712SigningLogicV4.sol";
import { PassportConfiguratorV4 } from "./libraries/PassportConfiguratorV4.sol";
import { UUPSUpgradeable } from "@openzeppelin/contracts-upgradeable/proxy/utils/UUPSUpgradeable.sol";
import { AccessControlUpgradeable } from "@openzeppelin/contracts-upgradeable/access/AccessControlUpgradeable.sol";
import { IVeBetterPassportV4 } from "../interfaces/IVeBetterPassportV4.sol";
import { IXAllocationVotingGovernor } from "../../../interfaces/IXAllocationVotingGovernor.sol";
import { IGalaxyMember } from "../../../interfaces/IGalaxyMember.sol";
import { IX2EarnApps } from "../../../interfaces/IX2EarnApps.sol";

/// @title VeBetterPassportV4
/// @notice Contract to manage the VeBetterPassportV4, a system to determine if a wallet is a person or not
 ...
 */
contract VeBetterPassportV4 is AccessControlUpgradeable, UUPSUpgradeable, IVeBetterPassportV4 {
  ...
  function getPassportStorage() internal pure returns (PassportStorageTypesV4.PassportStorage storage $) {
    assembly {
  ...
  function initialize(
    PassportTypesV4.InitializationData memory data,
    PassportTypesV4.InitializationRoleData memory roles
  ) external initializer {
    __UUPSUpgradeable_init();
    __AccessControl_init();

    PassportConfiguratorV4.initializePassportStorage(getPassportStorage(), data);
  ...
  function initializeV4(address _resetSignaler) external reinitializer(4) onlyRole(UPGRADER_ROLE) {
    require(_resetSignaler != address(0), "VeBetterPassportV4: reset signaler is the zero address");
  ...
  modifier onlyRoleOrAdmin(bytes32 role) {
    if (!hasRole(role, msg.sender) && !hasRole(DEFAULT_ADMIN_ROLE, msg.sender)) {
      revert VeBetterPassportV4UnauthorizedUser(msg.sender);
    }
    _;
  }
  ...
  function isPerson(address user) external view returns (bool person, string memory reason) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportPersonhoodLogicV4.isPerson($, user);
  }
  ...
  function isPersonAtTimepoint(
    ...
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportPersonhoodLogicV4.isPersonAtTimepoint($, user, timepoint);
  }
  ...
  function isCheckEnabled(PassportTypesV4.CheckType check) external view returns (bool) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportChecksLogicV4.isCheckEnabled($, check);
  }

  /// @notice Returns the minimum galaxy member level
  function getMinimumGalaxyMemberLevel() external view returns (uint256) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportChecksLogicV4.getMinimumGalaxyMemberLevel($);
  }

  /// @notice Returns if a user is whitelisted
  function isWhitelisted(address _user) external view returns (bool) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportWhitelistAndBlacklistLogicV4.isWhitelisted($, _user);
  }

  /// @notice Returns if a user is blacklisted
  function isBlacklisted(address _user) external view returns (bool) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportWhitelistAndBlacklistLogicV4.isBlacklisted($, _user);
  }
  ...
  function isPassportWhitelisted(address passport) external view returns (bool) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportWhitelistAndBlacklistLogicV4.isPassportWhitelisted($, passport);
  }
  ...
  function isPassportBlacklisted(address passport) external view returns (bool) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportWhitelistAndBlacklistLogicV4.isPassportBlacklisted($, passport);
  }
  ...
  function blacklistThreshold() external view returns (uint256) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportWhitelistAndBlacklistLogicV4.blacklistThreshold($);
  }
  ...
  function whitelistThreshold() external view returns (uint256) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportWhitelistAndBlacklistLogicV4.whitelistThreshold($);
  }
  ...
  function getCumulativeScoreWithDecay(address user, uint256 lastRound) external view returns (uint256) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportPoPScoreLogicV4.getCumulativeScoreWithDecay($, user, lastRound);
  }
  ...
  function userRoundScore(address user, uint256 round) external view returns (uint256) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportPoPScoreLogicV4.userRoundScore($, user, round);
  }
  ...
  function userTotalScore(address user) external view returns (uint256) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportPoPScoreLogicV4.userTotalScore($, user);
  }
  ...
  function userRoundScoreApp(address user, uint256 round, bytes32 appId) external view returns (uint256) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportPoPScoreLogicV4.userRoundScoreApp($, user, round, appId);
  }
  ...
  function thresholdPoPScoreAtTimepoint(uint48 timepoint) external view returns (uint256) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportPoPScoreLogicV4.thresholdPoPScoreAtTimepoint($, timepoint);
  }
  ...
  function securityMultiplier(PassportTypesV4.APP_SECURITY security) external view returns (uint256) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportPoPScoreLogicV4.securityMultiplier($, security);
  }
  ...
  function appSecurity(bytes32 appId) external view returns (PassportTypesV4.APP_SECURITY) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportPoPScoreLogicV4.appSecurity($, appId);
  }
  ...
  function maxEntitiesPerPassport() external view returns (uint256) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportEntityLogicV4.getMaxEntitiesPerPassport($);
  }
  ...
  function getPassportForEntity(address entity) external view returns (address) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportEntityLogicV4.getPassportForEntity($, entity);
  }
  ...
  function getPassportForEntityAtTimepoint(address entity, uint256 timepoint) external view returns (address) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportEntityLogicV4.getPassportForEntityAtTimepoint($, entity, timepoint);
  }
  ...
  function getEntitiesLinkedToPassport(address passport) external view returns (address[] memory) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportEntityLogicV4.getEntitiesLinkedToPassport($, passport);
  }
  ...
  function isEntity(address user) external view returns (bool) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportEntityLogicV4.isEntity($, user);
  }
  ...
  function isEntityInTimepoint(address user, uint256 timepoint) external view returns (bool) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportEntityLogicV4.isEntityInTimepoint($, user, timepoint);
  }
  ...
  function isPassport(address user) external view returns (bool) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportEntityLogicV4.isPassport($, user);
  }
  ...
  function isPassportInTimepoint(address user, uint256 timepoint) external view returns (bool) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportEntityLogicV4.isPassportInTimepoint($, user, timepoint);
  }
  ...
  function getPendingLinkings(address user) external view returns (address[] memory incoming, address outgoing) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportEntityLogicV4.getPendingLinkings($, user);
  }
  ...
  function getDelegatee(address delegator) external view returns (address) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportDelegationLogicV4.getDelegatee($, delegator);
  }
  ...
  function getDelegateeInTimepoint(address delegator, uint256 timepoint) external view returns (address) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportDelegationLogicV4.getDelegateeInTimepoint($, delegator, timepoint);
  }
  ...
  function getDelegator(address delegatee) external view returns (address) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportDelegationLogicV4.getDelegator($, delegatee);
  }
  ...
  function getDelegatorInTimepoint(address delegatee, uint256 timepoint) external view returns (address) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportDelegationLogicV4.getDelegatorInTimepoint($, delegatee, timepoint);
  }
  ...
  function isDelegator(address user) external view returns (bool) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportDelegationLogicV4.isDelegator($, user);
  }
  ...
  function isDelegatorInTimepoint(address user, uint256 timepoint) external view returns (bool) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportDelegationLogicV4.isDelegatorInTimepoint($, user, timepoint);
  }
  ...
  function isDelegatee(address user) external view returns (bool) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportDelegationLogicV4.isDelegatee($, user);
  }
  ...
  function isDelegateeInTimepoint(address user, uint256 timepoint) external view returns (bool) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportDelegationLogicV4.isDelegateeInTimepoint($, user, timepoint);
  }
  ...
  function getPendingDelegations(address user) external view returns (address[] memory incoming, address outgoing) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportDelegationLogicV4.getPendingDelegations($, user);
  }
  ...
  function appSignalsCounter(bytes32 _app, address _user) external view returns (uint256) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportSignalingLogicV4.appSignalsCounter($, _app, _user);
  }
  ...
  function getXAllocationVoting() external view returns (IXAllocationVotingGovernor) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportConfiguratorV4.getXAllocationVoting($);
  }

  /// @notice Gets the galaxy member contract address
  function getGalaxyMember() external view returns (IGalaxyMember) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    return PassportConfiguratorV4.getGalaxyMember($);
  }

  /// @notice Get the current block number
  function clock() external view returns (uint48) {
    return PassportClockLogicV4.clock();
  }

  /// @notice Get the clock mode
  function CLOCK_MODE() external pure returns (string memory) {
    return PassportClockLogicV4.CLOCK_MODE();
  }
  ...
  {
    return PassportEIP712SigningLogicV4.eip712Domain();
  }
  ...
  function toggleCheck(PassportTypesV4.CheckType check) external onlyRole(SETTINGS_MANAGER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportChecksLogicV4.toggleCheck($, check);
  }
  ...
  function whitelist(address _user) external onlyRoleOrAdmin(WHITELISTER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportWhitelistAndBlacklistLogicV4.whitelist($, _user);
  }
  ...
  function removeFromWhitelist(address _user) external onlyRoleOrAdmin(WHITELISTER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportWhitelistAndBlacklistLogicV4.removeFromWhitelist($, _user);
  }
  ...
  function blacklist(address _user) external onlyRoleOrAdmin(WHITELISTER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportWhitelistAndBlacklistLogicV4.blacklist($, _user);
  }
  ...
  function removeFromBlacklist(address _user) external onlyRoleOrAdmin(WHITELISTER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportWhitelistAndBlacklistLogicV4.removeFromBlacklist($, _user);
  }
  ...
  function setBlacklistThreshold(uint256 _threshold) external onlyRoleOrAdmin(SETTINGS_MANAGER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportWhitelistAndBlacklistLogicV4.setBlacklistThreshold($, _threshold);
  }
  ...
  function setWhitelistThreshold(uint256 _threshold) external onlyRoleOrAdmin(SETTINGS_MANAGER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportWhitelistAndBlacklistLogicV4.setWhitelistThreshold($, _threshold);
  }
  ...
  function registerAction(address user, bytes32 appId) external onlyRole(ACTION_REGISTRAR_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportPoPScoreLogicV4.registerAction($, user, appId);
  }
  ...
  function registerActionForRound(address user, bytes32 appId, uint256 round) external onlyRole(ACTION_REGISTRAR_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportPoPScoreLogicV4.registerActionForRound($, user, appId, round);
  }
  ...
  function registerAggregatedActionsForRound(
    ...
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportPoPScoreLogicV4.registerAggregatedActionsForRound($, user, appId, round, totalScore);
  }
  ...
  function setThresholdPoPScore(uint208 threshold) external onlyRoleOrAdmin(ACTION_SCORE_MANAGER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportPoPScoreLogicV4.setThresholdPoPScore($, threshold);
  }
  ...
  function setRoundsForCumulativeScore(uint256 rounds) external onlyRoleOrAdmin(ACTION_SCORE_MANAGER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportPoPScoreLogicV4.setRoundsForCumulativeScore($, rounds);
  }
  ...
  function setSecurityMultiplier(
    PassportTypesV4.APP_SECURITY security,
    uint256 multiplier
  ) external onlyRoleOrAdmin(ACTION_SCORE_MANAGER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportPoPScoreLogicV4.setSecurityMultiplier($, security, multiplier);
  }
  ...
  function setAppSecurity(
    ...
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportPoPScoreLogicV4.setAppSecurity($, appId, security);
  }
  ...
  function setDecayRate(uint256 _decayRate) external onlyRoleOrAdmin(DEFAULT_ADMIN_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportPoPScoreLogicV4.setDecayRate($, _decayRate);
  }
  ...
  function linkEntityToPassportWithSignature(address entity, uint256 deadline, bytes memory signature) external {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportEntityLogicV4.linkEntityToPassportWithSignature($, entity, deadline, signature);
  }
  ...
  function linkEntityToPassport(address passport) external {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportEntityLogicV4.linkEntityToPassport($, passport);
  }
  ...
  function acceptEntityLink(address entity) external {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportEntityLogicV4.acceptEntityLink($, entity);
  }
  ...
  function removeEntityLink(address entity) external {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportEntityLogicV4.removeEntityLink($, entity);
  }
  ...
  function denyIncomingPendingEntityLink(address entity) external {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportEntityLogicV4.denyIncomingPendingEntityLink($, entity);
  }

  /// @notice Cancel an outgoing pending entity link from the sender.
  function cancelOutgoingPendingEntityLink() external {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportEntityLogicV4.cancelOutgoingPendingEntityLink($);
  }
  ...
  function setMaxEntitiesPerPassport(uint256 maxEntities) external onlyRoleOrAdmin(SETTINGS_MANAGER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportEntityLogicV4.setMaxEntitiesPerPassport($, maxEntities);
  }
  ...
  function delegateWithSignature(address delegator, uint256 deadline, bytes memory signature) external {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportDelegationLogicV4.delegateWithSignature($, delegator, deadline, signature);
  }
  ...
  function delegatePassport(address delegatee) external {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportDelegationLogicV4.delegatePassport($, delegatee);
  }
  ...
  function acceptDelegation(address delegator) external {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportDelegationLogicV4.acceptDelegation($, delegator);
  }

  /// @notice Revoke the delegation (can be done by the delegator or the delegatee)
  function revokeDelegation() external {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportDelegationLogicV4.revokeDelegation($);
  }
  ...
  function denyIncomingPendingDelegation(address delegator) external {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportDelegationLogicV4.denyIncomingPendingDelegation($, delegator);
  }
  ...
  function cancelOutgoingPendingDelegation() external {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportDelegationLogicV4.cancelOutgoingPendingDelegation($);
  }

  /// @notice Signals a user
  function signalUser(address _user) external onlyRole(DEFAULT_ADMIN_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportSignalingLogicV4.signalUser($, _user);
  }
  ...
  function signalUserWithReason(address _user, string memory reason) external onlyRoleOrAdmin(SIGNALER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportSignalingLogicV4.signalUserWithReason($, _user, reason);
  }
  ...
  function assignSignalerToAppByAppAdmin(bytes32 app, address user) external {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportSignalingLogicV4.assignSignalerToAppByAppAdmin($, app, user);
  ...
  function removeSignalerFromAppByAppAdmin(address user) external {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportSignalingLogicV4.removeSignalerFromAppByAppAdmin($, user);
  ...
  function setSignalingThreshold(uint256 threshold) external onlyRoleOrAdmin(UPGRADER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportSignalingLogicV4.setSignalingThreshold($, threshold);
  }
  ...
  function assignSignalerToApp(bytes32 app, address user) external onlyRoleOrAdmin(ROLE_GRANTER) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportSignalingLogicV4.assignSignalerToApp($, app, user);
    _grantRole(SIGNALER_ROLE, user);
  }
  ...
  function removeSignalerFromApp(address user) external onlyRoleOrAdmin(ROLE_GRANTER) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportSignalingLogicV4.removeSignalerFromApp($, user);
    _revokeRole(SIGNALER_ROLE, user);
  }
  ...
  function resetUserSignalsWithReason(
    ...
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportSignalingLogicV4.resetUserSignals($, user, reason);
  }
  ...
  function resetUserSignalsByAppWithReason(address user, string memory reason) external onlyRoleOrAdmin(SIGNALER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportSignalingLogicV4.resetUserSignalsByAppWithReason($, user, reason);
  }
  ...
  function setMinimumGalaxyMemberLevel(uint256 _minimumGalaxyMemberLevel) external onlyRole(SETTINGS_MANAGER_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportChecksLogicV4.setMinimumGalaxyMemberLevel($, _minimumGalaxyMemberLevel);
  }
  ...
  function setXAllocationVoting(
    ...
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportConfiguratorV4.setXAllocationVoting($, xAllocationVoting);
  }
  ...
  function setGalaxyMember(IGalaxyMember galaxyMember) external onlyRoleOrAdmin(DEFAULT_ADMIN_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportConfiguratorV4.setGalaxyMember($, galaxyMember);
  }
  ...
  function setX2EarnApps(IX2EarnApps _x2EarnApps) external override onlyRole(DEFAULT_ADMIN_ROLE) {
    PassportStorageTypesV4.PassportStorage storage $ = getPassportStorage();
    PassportConfiguratorV4.setX2EarnApps($, _x2EarnApps);
  }
  ...
  function grantRole(
    bytes32 role,
    address account
  ) public override(AccessControlUpgradeable, IVeBetterPassportV4) onlyRoleOrAdmin(ROLE_GRANTER) {
