...
/**
 * @title PassportWhitelistAndBlacklistLogicV4
 ...
 */
library PassportWhitelistAndBlacklistLogicV4 {
  // ---------- Events ---------- //
  ...
  function isWhitelisted(PassportStorageTypesV4.PassportStorage storage self, address user) internal view returns (bool) {
    return self.whitelisted[user];
  }

  /// @notice Returns if a user is blacklisted
  function isBlacklisted(PassportStorageTypesV4.PassportStorage storage self, address user) internal view returns (bool) {
    return self.blacklisted[user];
  }

  /// @notice return the blacklist threshold
  function blacklistThreshold(PassportStorageTypesV4.PassportStorage storage self) internal view returns (uint256) {
    return self.blacklistThreshold;
  }

  /// @notice return the whitelist threshold
  function whitelistThreshold(PassportStorageTypesV4.PassportStorage storage self) internal view returns (uint256) {
  ...
  function whitelist(PassportStorageTypesV4.PassportStorage storage self, address user) external {
  ...
  function removeFromWhitelist(PassportStorageTypesV4.PassportStorage storage self, address user) public {
  ...
  function blacklist(PassportStorageTypesV4.PassportStorage storage self, address user) external {
  ...
  function removeFromBlacklist(PassportStorageTypesV4.PassportStorage storage self, address user) public {
  ...
  function setWhitelistThreshold(PassportStorageTypesV4.PassportStorage storage self, uint256 threshold) external {
  ...
  function setBlacklistThreshold(PassportStorageTypesV4.PassportStorage storage self, uint256 threshold) external {
  ...
  function _updatePassportBlacklistCounter(
    ...
    address passport = PassportEntityLogicV4._getPassportForEntity(self, user);
  ...
  function _isPassportWhitelisted(
    ...
    passport = PassportEntityLogicV4._getPassportForEntity(self, passport);
    ...
    uint256 totalEntities = PassportEntityLogicV4.getEntitiesLinkedToPassport(self, passport).length;
