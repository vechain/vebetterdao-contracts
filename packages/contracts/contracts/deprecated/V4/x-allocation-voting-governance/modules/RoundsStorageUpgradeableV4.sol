...
/**
 * @title RoundsStorageUpgradeableV4
 * @dev Extension of {XAllocationVotingGovernorV4} for storing rounds data and managing the rounds lifecycle.
 */
abstract contract RoundsStorageUpgradeableV4 is Initializable, XAllocationVotingGovernorV4 {
  struct RoundCore {
    address proposer;
    uint48 voteStart;
    uint32 voteDuration;
  ...
  /// @custom:storage-location erc7201:b3tr.storage.XAllocationVotingGovernorV4.RoundsStorage
  ...
  // keccak256(abi.encode(uint256(keccak256("b3tr.storage.XAllocationVotingGovernorV4.RoundsStorage")) - 1)) & ~bytes32(uint256(0xff))
