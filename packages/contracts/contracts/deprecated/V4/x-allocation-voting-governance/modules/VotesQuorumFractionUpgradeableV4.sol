...
import { VotesUpgradeableV4 } from "./VotesUpgradeableV4.sol";
import { SafeCast } from "@openzeppelin/contracts/utils/math/SafeCast.sol";
import { Checkpoints } from "@openzeppelin/contracts/utils/structs/Checkpoints.sol";
import { Initializable } from "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";

/**
 * @title VotesQuorumFractionUpgradeableV4
 * @dev Extension of {XAllocationVotingGovernorV4} for voting weight extraction from an {ERC20Votes} token and a quorum expressed as a
 * fraction of the total supply.
 */
abstract contract VotesQuorumFractionUpgradeableV4 is Initializable, VotesUpgradeableV4 {
  using Checkpoints for Checkpoints.Trace208;

  /// @custom:storage-location erc7201:b3tr.storage.XAllocationVotingGovernorV4.VotesQuorumFraction
  struct VotesQuorumFractionStorage {
    Checkpoints.Trace208 _quorumNumeratorHistory;
  }

  // keccak256(abi.encode(uint256(keccak256("b3tr.storage.XAllocationVotingGovernorV4.VotesQuorumFraction")) - 1)) & ~bytes32(uint256(0xff))
