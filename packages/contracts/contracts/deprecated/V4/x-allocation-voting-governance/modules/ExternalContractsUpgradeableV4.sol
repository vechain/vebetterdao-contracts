...
/**
 * @title ExternalContractsUpgradeableV4
 * @dev Extension of {XAllocationVotingGovernorV4} that handles the storage of external contracts for the XAllocationVotingGovernorV4.
 */
abstract contract ExternalContractsUpgradeableV4 is Initializable, XAllocationVotingGovernorV4 {
  /// @custom:storage-location erc7201:b3tr.storage.XAllocationVotingGovernorV4.ExternalContracts
  ...
  // keccak256(abi.encode(uint256(keccak256("b3tr.storage.XAllocationVotingGovernorV4.ExternalContracts")) - 1)) & ~bytes32(uint256(0xff))
  ...
  function _setEmissions(IEmissions newEmisionsAddress) internal virtual {
    require(address(newEmisionsAddress) != address(0), "XAllocationVotingGovernorV4: emissions is the zero address");
    ExternalContractsStorage storage $ = _getExternalContractsStorage();
  ...
  function _setX2EarnApps(IX2EarnApps newX2EarnApps) internal virtual {
    require(address(newX2EarnApps) != address(0), "XAllocationVotingGovernorV4: new X2EarnApps is the zero address");
  ...
  function _setVoterRewards(IVoterRewards newVoterRewards) internal virtual {
    require(
      address(newVoterRewards) != address(0),
      "XAllocationVotingGovernorV4: new voter rewards is the zero address"
    );
  ...
  function _setVeBetterPassport(IVeBetterPassport newVeBetterPassport) internal virtual {
    require(
      ...
      "XAllocationVotingGovernorV4: new VeBetterPassport is the zero address"
    );
