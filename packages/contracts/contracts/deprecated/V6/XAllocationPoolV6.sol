...
import { IXAllocationPoolV6 as IXAllocationPool } from "./interfaces/IXAllocationPoolV6.sol";
 ...
 */
contract XAllocationPoolV6 is IXAllocationPool, AccessControlUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
  ...
  function toggleQuadraticFunding() external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    emit QuadraticFundingToggled(!isQuadraticDisabled);
  }
