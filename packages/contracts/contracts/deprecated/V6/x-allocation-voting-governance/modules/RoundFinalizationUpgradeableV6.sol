 ...
 * @notice Extension of {XAllocationVotingGovernorV6} that handles the finalization of rounds
 ...
 */
abstract contract RoundFinalizationUpgradeableV6 is Initializable, XAllocationVotingGovernorV6 {
  /// @custom:storage-location erc7201:b3tr.storage.XAllocationVotingGovernorV6.RoundFinalization
  ...
  // keccak256(abi.encode(uint256(keccak256("b3tr.storage.XAllocationVotingGovernorV6.RoundFinalization")) - 1)) & ~bytes32(uint256(0xff))
  ...
  function finalizeRound(uint256 roundId) public virtual override {
    require(!isActive(roundId), "XAllocationVotingGovernorV6: round is not ended yet");
