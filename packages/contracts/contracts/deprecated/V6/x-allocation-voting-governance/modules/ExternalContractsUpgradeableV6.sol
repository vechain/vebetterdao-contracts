...
import { XAllocationVotingGovernorV6 } from "../XAllocationVotingGovernorV6.sol";
 ...
 * @dev Extension of {XAllocationVotingGovernorV6} that handles the storage of external contracts for the XAllocationVotingGovernorV6.
 */
abstract contract ExternalContractsUpgradeableV6 is Initializable, XAllocationVotingGovernorV6 {
  /// @custom:storage-location erc7201:b3tr.storage.XAllocationVotingGovernorV6.ExternalContracts
  ...
  // keccak256(abi.encode(uint256(keccak256("b3tr.storage.XAllocationVotingGovernorV6.ExternalContracts")) - 1)) & ~bytes32(uint256(0xff))
  ...
  function _setEmissions(IEmissions newEmisionsAddress) internal virtual {
    require(address(newEmisionsAddress) != address(0), "XAllocationVotingGovernorV6: emissions is the zero address");
    ExternalContractsStorage storage $ = _getExternalContractsStorage();
  ...
  function _setX2EarnApps(IX2EarnApps newX2EarnApps) internal virtual {
    require(address(newX2EarnApps) != address(0), "XAllocationVotingGovernorV6: new X2EarnApps is the zero address");
  ...
  function _setVoterRewards(IVoterRewards newVoterRewards) internal virtual {
    require(address(newVoterRewards) != address(0), "XAllocationVotingGovernorV6: new voter rewards is the zero address");
  ...
  function _setVeBetterPassport(IVeBetterPassport newVeBetterPassport) internal virtual {
    require(
      ...
      "XAllocationVotingGovernorV6: new VeBetterPassport is the zero address"
    );
