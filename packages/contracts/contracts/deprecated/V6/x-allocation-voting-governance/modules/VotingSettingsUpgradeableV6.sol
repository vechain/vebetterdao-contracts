...
/**
 * @title VotingSettingsUpgradeableV6
 * @dev Extension of {XAllocationVotingGovernorV6} for voting settings.
 */
abstract contract VotingSettingsUpgradeableV6 is Initializable, XAllocationVotingGovernorV6 {
  /// @custom:storage-location erc7201:b3tr.storage.XAllocationVotingGovernorV6.VotingSettings
  struct VotingSettingsStorage {
    uint32 _votingPeriod;
  }

  // keccak256(abi.encode(uint256(keccak256("b3tr.storage.XAllocationVotingGovernorV6.VotingSettings")) - 1)) & ~bytes32(uint256(0xff))
