...
/**
 * @title RoundsStorageUpgradeableV6
 * @dev Extension of {XAllocationVotingGovernorV6} for storing rounds data and managing the rounds lifecycle.
 */
abstract contract RoundsStorageUpgradeableV6 is Initializable, XAllocationVotingGovernorV6 {
  struct RoundCore {
    address proposer;
    uint48 voteStart;
    uint32 voteDuration;
  ...
  /// @custom:storage-location erc7201:b3tr.storage.XAllocationVotingGovernorV6.RoundsStorage
  ...
  // keccak256(abi.encode(uint256(keccak256("b3tr.storage.XAllocationVotingGovernorV6.RoundsStorage")) - 1)) & ~bytes32(uint256(0xff))
