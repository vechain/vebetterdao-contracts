...
import { IX2EarnAppsV6 } from "../interfaces/IX2EarnAppsV6.sol";
 ...
 */
abstract contract X2EarnAppsUpgradeableV6 is Initializable, IX2EarnAppsV6 {
  // ---------- Getters ---------- //
  /**
  ...
  /**
   * @dev See {IX2EarnAppsV6-hashAppName}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV6-appAdmin}
   */
  function appAdmin(bytes32 appId) public view virtual returns (address);

  /**
   * @dev See {IX2EarnAppsV6-teamAllocationPercentage}
   */
