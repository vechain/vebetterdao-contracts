...
import { X2EarnAppsUpgradeableV6 } from "../X2EarnAppsUpgradeableV6.sol";
import { AdministrationUtilsV6 } from "../libraries/AdministrationUtilsV6.sol";
import { IX2EarnCreator } from "../../../../interfaces/IX2EarnCreator.sol";
import { IX2EarnRewardsPool } from "../../../../interfaces/IX2EarnRewardsPool.sol";
/**
 * @title AdministrationUpgradeableV6
 ...
 */
abstract contract AdministrationUpgradeableV6 is Initializable, X2EarnAppsUpgradeableV6 {
  ...
  function _setAppAdmin(bytes32 appId, address newAdmin) internal override {
    ...
    AdministrationUtilsV6.setAppAdmin($._admin, appId, newAdmin, _appSubmitted(appId));
  }
  ...
  function _addAppModerator(bytes32 appId, address moderator) internal {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV6.addAppModerator($._moderators, appId, moderator, _appSubmitted(appId), MAX_MODERATORS);
  }
  ...
  function _removeAppModerator(bytes32 appId, address moderator) internal {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV6.removeAppModerator($._moderators, appId, moderator, _appSubmitted(appId));
  }
  ...
  function _removeAppCreator(bytes32 appId, address creator) internal {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV6.removeAppCreator(
      $._creators,
      $._creatorApps,
  ...
  function _addCreator(bytes32 appId, address creator) internal override {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV6.addCreator(
      $._creators,
      $._creatorApps,
      $._x2EarnCreatorContract,
      appId,
  ...
  function _addRewardDistributor(bytes32 appId, address distributor) internal {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV6.addRewardDistributor(
      $._rewardDistributors,
      appId,
      distributor,
      _appSubmitted(appId),
  ...
  function _removeRewardDistributor(bytes32 appId, address distributor) internal {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV6.removeRewardDistributor($._rewardDistributors, appId, distributor, _appSubmitted(appId));
  }
  ...
  function _enableRewardsPoolForNewApp(bytes32 appId) internal override {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV6.enableRewardsPoolForNewApp($._x2EarnRewardsPoolContract, appId);
  }
  ...
  function _updateTeamWalletAddress(bytes32 appId, address newTeamWalletAddress) internal override {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV6.updateTeamWalletAddress(
      $._teamWalletAddress,
      appId,
  ...
  function _updateAppMetadata(bytes32 appId, string memory newMetadataURI) internal override {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV6.updateAppMetadata($._metadataURI, appId, newMetadataURI, _appSubmitted(appId));
  }
  ...
  function _setTeamAllocationPercentage(bytes32 appId, uint256 newAllocationPercentage) internal virtual override {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV6.setTeamAllocationPercentage(
  ...
  function _revokeAppCreators(bytes32 appId) internal {
    ...
    if (!isBlacklisted(appId))
      AdministrationUtilsV6.revokeAppCreators($._creators, $._creatorApps, $._x2EarnCreatorContract, appId);
  }
  ...
  function _validateAppCreators(bytes32 appId) internal {
    AdministrationStorage storage $ = _getAdministrationStorage();
    if (isBlacklisted(appId))
      AdministrationUtilsV6.validateAppCreators($._creators, $._creatorApps, $._x2EarnCreatorContract, appId);
  }
  ...
  function isAppCreator(bytes32 appId, address account) external view returns (bool) {
    ...
    return AdministrationUtilsV6.isAppCreator($._creators, appId, account);
  }
  ...
  function isAppModerator(bytes32 appId, address account) public view returns (bool) {
    AdministrationStorage storage $ = _getAdministrationStorage();
    return AdministrationUtilsV6.isAppModerator($._moderators, appId, account);
  }
  ...
  function isRewardDistributor(bytes32 appId, address account) public view returns (bool) {
    ...
    return AdministrationUtilsV6.isRewardDistributor($._rewardDistributors, appId, account);
  }
