...
import { VoteEligibilityUtilsV6 } from "../libraries/VoteEligibilityUtilsV6.sol";

/**
 * @title VoteEligibilityUpgradeableV6
 ...
 */
abstract contract VoteEligibilityUpgradeableV6 is Initializable, X2EarnAppsUpgradeableV6 {
  ...
  function _setVotingEligibility(bytes32 appId, bool canBeVoted) internal override {
    ...
    VoteEligibilityUtilsV6.updateVotingEligibility(
      $._eligibleApps,
  ...
  function isEligible(bytes32 appId, uint256 timepoint) public view override returns (bool) {
    ...
    return VoteEligibilityUtilsV6.isEligible(
      $._isAppEligibleCheckpoints,
      appId,
      timepoint,
      appExists(appId),
