...
library GovernorFunctionRestrictionsLogicV8 {
   ...
   */
  function setIsFunctionRestrictionEnabled(GovernorStorageTypesV8.GovernorStorage storage self, bool isEnabled) external {
