...
library GovernorConfiguratorV8 {
   ...
   */
  function setMinVotingDelay(GovernorStorageTypesV8.GovernorStorage storage self, uint256 newMinVotingDelay) external {
   ...
   */
  function setVoterRewards(GovernorStorageTypesV8.GovernorStorage storage self, IVoterRewards newVoterRewards) external {
  ...
  function setProposalTypeDepositThresholdPercentage(
    ...
    require(GovernorProposalLogicV8.isValidProposalType(proposalType), "GovernorConfigurator: invalid proposal type");
   ...
   */
  function getMinVotingDelay(GovernorStorageTypesV8.GovernorStorage storage self) internal view returns (uint256) {
  ...
  function getRequiredGMLevelByProposalType(
    ...
    require(
      GovernorProposalLogicV8.isValidProposalType(proposalTypeValue),
