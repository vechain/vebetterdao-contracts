...
library GovernorQuorumLogicV8 {
  ...
  function quorumNumerator(
    ...
    GovernorTypesV8.ProposalType proposalType = GovernorTypesV8.ProposalType.Standard;
  ...
  function quorumNumerator(GovernorStorageTypesV8.GovernorStorage storage self) public view returns (uint256) {
    GovernorTypesV8.ProposalType proposalType = GovernorTypesV8.ProposalType.Standard;
   ...
   */
  function quorum(GovernorStorageTypesV8.GovernorStorage storage self, uint256 timepoint) public view returns (uint256) {
  ...
  function updateQuorumNumerator(
    ...
    _updateQuorumNumeratorByType(self, newQuorumNumerator, GovernorTypesV8.ProposalType.Standard);
  }
  /**
  ...
  function quorumReached(
    ...
    return
      quorumByProposalType(self, GovernorProposalLogicV8._proposalSnapshot(self, proposalId), proposalType) <=
  ...
  function _updateQuorumNumeratorByType(
    ...
    self.proposalTypeQuorum[proposalTypeValue].push(
      GovernorClockLogicV8.clock(self),
