...
interface IX2EarnAppsV7 {
   ...
   */
  event NodeStrengthScoresUpdated(EndorsementUtilsV7.NodeStrengthScores indexed nodeStrengthScores);
   ...
   */
  function updateNodeEndorsementScores(EndorsementUtilsV7.NodeStrengthScores calldata _nodeStrengthScores) external;
