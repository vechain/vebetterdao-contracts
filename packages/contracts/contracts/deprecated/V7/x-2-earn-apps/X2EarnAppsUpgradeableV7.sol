...
import { IX2EarnAppsV7 } from "../interfaces/IX2EarnAppsV7.sol";
 ...
 */
abstract contract X2EarnAppsUpgradeableV7 is Initializable, IX2EarnAppsV7 {
  ...
  /**
   * @dev See {IX2EarnAppsV7-hashAppName}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV7-appAdmin}
   */
  function appAdmin(bytes32 appId) public view virtual returns (address);

  /**
   * @dev See {IX2EarnAppsV7-teamAllocationPercentage}
   */
