...
library GovernorStorageTypesV7 {
  struct GovernorStorage {
    // ------------------------------- Version 1 -------------------------------

    // ------------------------------- General Storage -------------------------------
    string name; // name of the Governor
    mapping(uint256 proposalId => GovernorTypesV7.ProposalCore) proposals;
    ...
    mapping(uint256 => GovernorTypesV7.ProposalVote) proposalVotes;
    ...
    mapping(uint256 => GovernorTypesV7.ProposalType) proposalType;
    // mapping to store the deposit threshold percentage for each proposal type
    mapping(GovernorTypesV7.ProposalType => uint256) proposalTypeDepositThresholdPercentage;
    // mapping to store the voting threshold for each proposal type
    mapping(GovernorTypesV7.ProposalType => uint256) proposalTypeVotingThreshold;
    // mapping to store the quorum history for each proposal type
    mapping(GovernorTypesV7.ProposalType => Checkpoints.Trace208) proposalTypeQuorum;
    ...
    mapping(GovernorTypesV7.ProposalType => uint256) requiredGMLevelByProposalType;
