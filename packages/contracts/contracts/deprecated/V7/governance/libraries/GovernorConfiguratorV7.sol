...
library GovernorConfiguratorV7 {
   ...
   */
  function setMinVotingDelay(GovernorStorageTypesV7.GovernorStorage storage self, uint256 newMinVotingDelay) external {
  ...
  function setProposalTypeDepositThresholdPercentage(
    ...
    require(GovernorProposalLogicV7.isValidProposalType(proposalType), "GovernorConfigurator: invalid proposal type");
   ...
   */
  function getMinVotingDelay(GovernorStorageTypesV7.GovernorStorage storage self) internal view returns (uint256) {
  ...
  function getRequiredGMLevelByProposalType(
    ...
    require(
      GovernorProposalLogicV7.isValidProposalType(proposalTypeValue),
