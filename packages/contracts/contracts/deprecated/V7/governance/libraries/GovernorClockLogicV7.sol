...
/// @title GovernorClockLogicV7 Library
...
library GovernorClockLogicV7 {
   ...
   */
  function clock(GovernorStorageTypesV7.GovernorStorage storage self) external view returns (uint48) {
  ...
  function CLOCK_MODE(GovernorStorageTypesV7.GovernorStorage storage self) external view returns (string memory) {
