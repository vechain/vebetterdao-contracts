...
library GovernorQuorumLogicV7 {
  ...
  function quorumNumerator(
    ...
    GovernorTypesV7.ProposalType proposalType = GovernorTypesV7.ProposalType.Standard;
  ...
  function quorumNumerator(GovernorStorageTypesV7.GovernorStorage storage self) public view returns (uint256) {
    GovernorTypesV7.ProposalType proposalType = GovernorTypesV7.ProposalType.Standard;
  ...
  function updateQuorumNumerator(
    ...
    _updateQuorumNumeratorByType(self, newQuorumNumerator, GovernorTypesV7.ProposalType.Standard);
  }
  /**
  ...
  function quorumReached(
    ...
    GovernorTypesV7.ProposalType proposalType = self.proposalType[proposalId];

    return
      quorumByProposalType(self, GovernorProposalLogicV7._proposalSnapshot(self, proposalId), proposalType) <=
  ...
  function _updateQuorumNumeratorByType(
    ...
    self.proposalTypeQuorum[proposalTypeValue].push(
      GovernorClockLogicV7.clock(self),
