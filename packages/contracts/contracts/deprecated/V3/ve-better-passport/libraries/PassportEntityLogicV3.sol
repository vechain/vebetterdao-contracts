...
import { PassportEIP712SigningLogicV3 } from "./PassportEIP712SigningLogicV3.sol";
...
library PassportEntityLogicV3 {
   ...
   */
  function isEntity(PassportStorageTypesV3.PassportStorage storage self, address entity) internal view returns (bool) {
  ...
  function linkEntityToPassportWithSignature(
    ...
    bytes32 digest = PassportEIP712SigningLogicV3.hashTypedDataV4(structHash);
   ...
   */
  function linkEntityToPassport(PassportStorageTypesV3.PassportStorage storage self, address passport) external {
   ...
   */
  function acceptEntityLink(PassportStorageTypesV3.PassportStorage storage self, address entity) external {
   ...
   */
  function removeEntityLink(PassportStorageTypesV3.PassportStorage storage self, address entity) external {
   ...
   */
  function denyIncomingPendingEntityLink(PassportStorageTypesV3.PassportStorage storage self, address entity) external {
    address passport = self.pendingLinksEntityToPassport[entity];
    if (passport == address(0)) {
      revert NotLinked(entity);
    }
   ...
   */
  function cancelOutgoingPendingEntityLink(PassportStorageTypesV3.PassportStorage storage self) external {
   ...
   */
  function setMaxEntitiesPerPassport(PassportStorageTypesV3.PassportStorage storage self, uint256 maxEntities) external {
  ...
  function _pushCheckpoint(Checkpoints.Trace160 storage store, address value) private {
    store.push(PassportClockLogicV3.clock(), uint160(value));
  }
  ...
  function _removeEntityLink(
    ...
    PassportSignalingLogicV3.removeEntitySignalsFromPassport(self, entity, passport);
    PassportWhitelistAndBlacklistLogicV3.removeEntitiesBlackAndWhiteListsFromPassport(self, entity, passport);
  }
   ...
   * @param passport The address of the passport to which the entity is being linked.
   */
  function _linkEntity(PassportStorageTypesV3.PassportStorage storage self, address entity, address passport) private {
    ...
    PassportSignalingLogicV3.attachEntitySignalsToPassport(self, entity, passport);
    PassportWhitelistAndBlacklistLogicV3.attachEntitiesBlackAndWhiteListsToPassport(self, entity, passport);
  ...
  function _checkLink(
    ...
    if (
      PassportDelegationLogicV3.isDelegator(self, entity) ||
    ...
    if (
      PassportDelegationLogicV3.isDelegatee(self, entity) ||
