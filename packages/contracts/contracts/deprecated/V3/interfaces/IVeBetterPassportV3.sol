...
import { PassportTypesV3 } from "../ve-better-passport/libraries/PassportTypesV3.sol";
import { IX2EarnApps } from "../../../interfaces/IX2EarnApps.sol";
import { IXAllocationVotingGovernor } from "../../../interfaces/IXAllocationVotingGovernor.sol";

interface IVeBetterPassportV3 {
  // ---------- Events ---------- //
  ...
  function initialize(
    PassportTypesV3.InitializationData calldata data,
    PassportTypesV3.InitializationRoleData calldata roles
  ) external;
  ...
  function toggleCheck(PassportTypesV3.CheckType check) external;
  ...
  function setSecurityMultiplier(PassportTypesV3.APP_SECURITY security, uint256 multiplier) external;

  /// @notice Sets the app security level for a specific app
  /// @param appId The app ID
  /// @param security The security level
  function setAppSecurity(bytes32 appId, PassportTypesV3.APP_SECURITY security) external;
