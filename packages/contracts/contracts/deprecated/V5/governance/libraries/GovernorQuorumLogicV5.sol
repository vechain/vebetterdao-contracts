...
library GovernorQuorumLogicV5 {
  ...
  /// @notice Retrieves the latest quorum numerator using the GovernorClockLogicV5 library.
  /// @param self The storage structure containing the quorum numerator history.
  ...
  function updateQuorumNumerator(
    ...
    self.quorumNumeratorHistory.push(GovernorClockLogicV5.clock(self), SafeCast.toUint208(newQuorumNumerator));
  ...
  function quorumReached(
    ...
    return
      quorum(self, GovernorProposalLogicV5._proposalSnapshot(self, proposalId)) <= self.proposalTotalVotes[proposalId];
  }
}
