...
import { X2EarnAppsUpgradeableV5 } from "./x-2-earn-apps/X2EarnAppsUpgradeableV5.sol";
import { AdministrationUpgradeableV5 } from "./x-2-earn-apps/modules/AdministrationUpgradeableV5.sol";
import { AppsStorageUpgradeableV5 } from "./x-2-earn-apps/modules/AppsStorageUpgradeableV5.sol";
import { ContractSettingsUpgradeableV5 } from "./x-2-earn-apps/modules/ContractSettingsUpgradeableV5.sol";
import { VoteEligibilityUpgradeableV5 } from "./x-2-earn-apps/modules//VoteEligibilityUpgradeableV5.sol";
import { EndorsementUpgradeableV5 } from "./x-2-earn-apps/modules/EndorsementUpgradeableV5.sol";
 ...
 */
contract X2EarnAppsV5 is
  X2EarnAppsUpgradeableV5,
  AdministrationUpgradeableV5,
  ContractSettingsUpgradeableV5,
  VoteEligibilityUpgradeableV5,
  AppsStorageUpgradeableV5,
  EndorsementUpgradeableV5,
