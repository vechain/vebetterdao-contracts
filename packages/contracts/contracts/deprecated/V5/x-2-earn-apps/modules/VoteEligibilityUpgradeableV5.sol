...
import { VoteEligibilityUtilsV5 } from "../libraries/VoteEligibilityUtilsV5.sol";
 ...
 */
abstract contract VoteEligibilityUpgradeableV5 is Initializable, X2EarnAppsUpgradeableV5 {
  ...
  function _setVotingEligibility(bytes32 appId, bool canBeVoted) internal override {
    ...
    // Use VoteEligibilityUtilsV5 to update the eligibility checkpoint
    VoteEligibilityUtilsV5.updateVotingEligibility(
      $._eligibleApps,
  ...
  function isEligible(bytes32 appId, uint256 timepoint) public view override returns (bool) {
    ...
    // Use VoteEligibilityUtilsV5 to check if the app is eligible at the given timepoint
    return VoteEligibilityUtilsV5.isEligible(
      $._isAppEligibleCheckpoints,
      appId,
      timepoint,
      appExists(appId),
