...
import { AppStorageUtilsV5 } from "../libraries/AppStorageUtilsV5.sol";
 ...
 */
abstract contract AppsStorageUpgradeableV5 is Initializable, X2EarnAppsUpgradeableV5 {
  ...
  function getPaginatedApps(uint startIndex, uint count) external view returns (X2EarnAppsDataTypes.App[] memory) {
    ...
    return AppStorageUtilsV5.getPaginatedApps($._apps, $._appIds, startIndex, count);
  }
