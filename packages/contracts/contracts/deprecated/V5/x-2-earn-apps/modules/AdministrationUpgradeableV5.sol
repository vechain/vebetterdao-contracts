...
import { AdministrationUtilsV5 } from "../libraries/AdministrationUtilsV5.sol";
 ...
 */
abstract contract AdministrationUpgradeableV5 is Initializable, X2EarnAppsUpgradeableV5 {
  ...
  function _setAppAdmin(bytes32 appId, address newAdmin) internal override {
    ...
    AdministrationUtilsV5.setAppAdmin($._admin, appId, newAdmin, _appSubmitted(appId));
  }
  ...
  function _addAppModerator(bytes32 appId, address moderator) internal {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV5.addAppModerator($._moderators, appId, moderator, _appSubmitted(appId), MAX_MODERATORS);
  }
  ...
  function _removeAppModerator(bytes32 appId, address moderator) internal {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV5.removeAppModerator($._moderators, appId, moderator, _appSubmitted(appId));
  }
  ...
  function _removeAppCreator(bytes32 appId, address creator) internal {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV5.removeAppCreator(
      $._creators,
      $._creatorApps,
  ...
  function _addCreator(bytes32 appId, address creator) internal override {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV5.addCreator(
      $._creators,
      $._creatorApps,
      $._x2EarnCreatorContract,
      appId,
  ...
  function _addRewardDistributor(bytes32 appId, address distributor) internal {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV5.addRewardDistributor(
      $._rewardDistributors,
      appId,
      distributor,
      _appSubmitted(appId),
  ...
  function _removeRewardDistributor(bytes32 appId, address distributor) internal {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV5.removeRewardDistributor($._rewardDistributors, appId, distributor, _appSubmitted(appId));
  }
  ...
  function _enableRewardsPoolForNewApp(bytes32 appId) internal override {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV5.enableRewardsPoolForNewApp($._x2EarnRewardsPoolContract, appId);
  }
  ...
  function _updateTeamWalletAddress(bytes32 appId, address newTeamWalletAddress) internal override {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV5.updateTeamWalletAddress(
      $._teamWalletAddress,
      appId,
  ...
  function _updateAppMetadata(bytes32 appId, string memory newMetadataURI) internal override {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV5.updateAppMetadata($._metadataURI, appId, newMetadataURI, _appSubmitted(appId));
  }
  ...
  function _setTeamAllocationPercentage(bytes32 appId, uint256 newAllocationPercentage) internal virtual override {
    AdministrationStorage storage $ = _getAdministrationStorage();
    AdministrationUtilsV5.setTeamAllocationPercentage(
  ...
  function _revokeAppCreators(bytes32 appId) internal {
    ...
    if (!isBlacklisted(appId))
      AdministrationUtilsV5.revokeAppCreators($._creators, $._creatorApps, $._x2EarnCreatorContract, appId);
  }
  ...
  function _validateAppCreators(bytes32 appId) internal {
    AdministrationStorage storage $ = _getAdministrationStorage();
    if (isBlacklisted(appId))
      AdministrationUtilsV5.validateAppCreators($._creators, $._creatorApps, $._x2EarnCreatorContract, appId);
  }
  ...
  function isAppCreator(bytes32 appId, address account) external view returns (bool) {
    ...
    return AdministrationUtilsV5.isAppCreator($._creators, appId, account);
  }
  ...
  function isAppModerator(bytes32 appId, address account) public view returns (bool) {
    AdministrationStorage storage $ = _getAdministrationStorage();
    return AdministrationUtilsV5.isAppModerator($._moderators, appId, account);
  }
  ...
  function isRewardDistributor(bytes32 appId, address account) public view returns (bool) {
    ...
    return AdministrationUtilsV5.isRewardDistributor($._rewardDistributors, appId, account);
  }
