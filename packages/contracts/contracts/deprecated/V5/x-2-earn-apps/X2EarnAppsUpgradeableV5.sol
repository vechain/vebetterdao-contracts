 ...
 */
abstract contract X2EarnAppsUpgradeableV5 is Initializable, IX2EarnAppsV5 {
  ...
  /**
   * @dev See {IX2EarnAppsV5-hashAppName}.
   */
  ...
  /**
   * @dev See {IX2EarnAppsV5-appAdmin}
   */
  function appAdmin(bytes32 appId) public view virtual returns (address);

  /**
   * @dev See {IX2EarnAppsV5-teamAllocationPercentage}
   */
