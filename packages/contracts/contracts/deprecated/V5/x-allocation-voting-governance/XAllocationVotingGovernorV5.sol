...
import { IXAllocationVotingGovernorV5, IERC6372 } from "../interfaces/IXAllocationVotingGovernorV5.sol";
 ...
 */
abstract contract XAllocationVotingGovernorV5 is
  Initializable,
  ContextUpgradeable,
  ERC165Upgradeable,
  IXAllocationVotingGovernorV5
{
  ...
  function supportsInterface(
    ...
    return interfaceId == type(IXAllocationVotingGovernorV5).interfaceId || super.supportsInterface(interfaceId);
  }
   ...
   */
  function emissions() public view virtual returns (IEmissionsV2);

  /**
   * @dev Returns the VoterRewards contract.
   */
  function voterRewards() public view virtual returns (IVoterRewardsV4);
}
