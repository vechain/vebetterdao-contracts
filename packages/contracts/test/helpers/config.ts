...
export function createTestConfig() {
  return defineConfig({
    ...
    B3TR_GOVERNOR_WHITELISTED_METHODS: {
      B3TR: ["tokenDetails", "createMilestone"],
...
*/
    ...
    // TO DEFINE FOR TESTS
    B3TR_GOVERNOR_GRANT_QUORUM_PERCENTAGE: 2,
    MINIMUM_MILESTONE_COUNT: 2,
    B3TR_GOVERNOR_GRANT_DEPOSIT_THRESHOLD: 2,
    B3TR_GOVERNOR_GRANT_VOTING_THRESHOLD: BigInt("1000000000000000000"),
    B3TR_GOVERNOR_GRANT_DEPOSIT_THRESHOLD_CAP: BigInt("3500000000000000000000000"),
    B3TR_GOVERNOR_STANDARD_DEPOSIT_THRESHOLD_CAP: BigInt("5000000000000000000000000"),
